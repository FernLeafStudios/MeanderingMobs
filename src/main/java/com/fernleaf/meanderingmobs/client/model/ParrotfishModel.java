...
public class ParrotfishModel<T extends LivingEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Parrotfish = partdefinition.addOrReplaceChild("Parrotfish", CubeListBuilder.create(), PartPose.offset(0.0F, 19.0F, -11.0F));
        ...
        PartDefinition head = Parrotfish.addOrReplaceChild("head", CubeListBuilder.create().texOffs(55, 111).addBox(-2.5F, -13.0F, -10.0F, 5.0F, 8.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(59, 74).addBox(-2.5F, -5.0F, -8.0F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition body = Parrotfish.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, -10.0F, 1.0F));
