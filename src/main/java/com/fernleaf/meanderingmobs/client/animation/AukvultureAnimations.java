...
public class AukvultureAnimations {
	...
	public static final AnimationDefinition landing = AnimationDefinition.Builder.withLength(3.25F)
		...
		.addAnimation("Aukvulture", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 5.74F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.25F, KeyframeAnimations.posVec(0.0F, 3.09F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
