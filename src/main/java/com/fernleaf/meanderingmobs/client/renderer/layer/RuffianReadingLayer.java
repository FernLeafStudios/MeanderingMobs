...
public class RuffianReadingLayer extends RenderLayer<RuffianEntity, HierarchicalModel<RuffianEntity>> {
    ...
    public RuffianReadingLayer(RenderLayerParent<RuffianEntity, HierarchicalModel<RuffianEntity>> renderer) {
        super(renderer);
    ...
    public void render(@NotNull PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight, @NotNull RuffianEntity entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // Shift forward on Z and adjust Y to center it right in front of their hunched chest
