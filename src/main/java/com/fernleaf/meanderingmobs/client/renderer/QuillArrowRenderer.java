...
public class QuillArrowRenderer extends ArrowRenderer<QuillArrowEntity> {
    ...
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MeanderingMobs.MODID, "textures/entity/projectiles/quill_arrow.png");
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull QuillArrowEntity entity) {
        return TEXTURE;
    }
}