...
public class MeanderingMobsBlockEntityRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<QueueboxBlockEntity>> QUEUEBOX =
            BLOCK_ENTITIES.register("queuebox_block",
                    () -> BlockEntityType.Builder.of(QueueboxBlockEntity::new,
                            MeanderingMobsBlockRegistry.QUEUEBOX.get()).build(null));
